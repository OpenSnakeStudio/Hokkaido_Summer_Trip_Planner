  ...
  B: [
    {
      ...
      photos: ["https://images.unsplash.com/photo-1674725690428-948af1d7f5a1?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1614563637806-1d0e645e0940?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1704135489566-3929fc2a4fec?auto=format&fit=crop&q=80&w=300"]
    },
    {
      day: 2,
      date: "07/08 Wed.",
      ...
      photos: ["https://images.unsplash.com/photo-1631848351521-c99aed909530?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1722482445722-19c5c4989ec6?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1659656066247-053c5150dea5?auto=format&fit=crop&q=80&w=300"]
    },
    {
      day: 3,
      date: "07/09 Thu.",
      ...
      photos: ["https://images.unsplash.com/photo-1687784529277-3d3709faec5e?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1757140093290-3ff3d53d9b85?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1722482445722-19c5c4989ec6?auto=format&fit=crop&q=80&w=300"]
    },
    {
      day: 4,
      date: "07/10 Fri.",
      ...
      photos: ["https://images.unsplash.com/photo-1469334031218-e382a71b716b?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1505144808419-1957a94ca61e?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1596677352741-0d3d0431c123?auto=format&fit=crop&q=80&w=300"]
    },
    {
      day: 5,
      date: "07/11 Sat.",
      ...
      photos: ["https://images.unsplash.com/photo-1645611539916-e9b328d3832c?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1557409518-691ebcd96038?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1605001011156-cbf0b0f67a51?auto=format&fit=crop&q=80&w=300"]
    },
    {
      day: 6,
      date: "07/12 Sun.",
      ...
      photos: ["https://images.unsplash.com/photo-1542931287-023b922fa89b?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1696677049468-73fb9c6aea2b?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1555529733-0e670560f7e1?auto=format&fit=crop&q=80&w=300"]
    },
    {
      day: 7,
      date: "07/13 Mon.",
      title: "最終採買一",
      spots: ["二條市場：海鮮丼早餐", "北海道大學：銀杏林散策", "三井 Outlet Park 札幌北廣島"],
      photos: ["https://images.unsplash.com/photo-1575253301299-db3f10d814dd?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1535924571710-4c6e27716b6d?auto=format&fit=crop&q=80&w=300"]
    },
    {
      day: 8,
      date: "07/14 Tue.",
      title: "最終採買與歸途",
      spots: ["機場還車中心：歸還租賃車", "新千歲機場國內線：Royce 巧克力", "機場美食區：最後一碗拉麵", "平安登機，告別北海道"],
      photos: ["https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&q=80&w=300", "https://images.unsplash.com/photo-1535924571710-4c6e27716b6d?auto=format&fit=crop&q=80&w=300"]
    }
  ]
};
      ...
      <main className="w-full max-w-md px-4">
        <section className="mb-20 bg-stone-200/20 p-6 rounded-[40px] border border-white/50 backdrop-blur-sm shadow-inner">
          <div className="flex flex-col gap-2 bg-stone-200/40 p-2 rounded-[28px] mb-8">
            <button className={`py-4 rounded-2xl font-bold transition-all ${currentPlan === 'A' ? 'bg-white text-wa-purple shadow-md' : 'text-stone-400'}`} onClick={() => handlePlanChange('A')}>PLAN A (7D)</button>
            <button className={`py-4 rounded-2xl font-bold transition-all ${currentPlan === 'B' ? 'bg-white text-wa-purple shadow-md' : 'text-stone-400'}`} onClick={() => handlePlanChange('B')}>PLAN B (8D)</button>
          </div>
